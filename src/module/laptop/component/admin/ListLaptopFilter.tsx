...
export type ListLaptopFilterProps = {
    filter: LaptopFilterParams
    onChangeFilter: React.Dispatch<React.SetStateAction<LaptopFilterParams>>
    onClearFilter: () => void
}

export function ListLaptopFilter({ filter, onChangeFilter, onClearFilter }: ListLaptopFilterProps) {
    return (
        <FilterComponent
            filter={filter}
